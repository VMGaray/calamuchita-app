...
const SUBCAT_LABELS: Record<string, string> = {
  ...
  "ambientacion-eventos": "Ambientación de eventos",
  "artista-plastica": "Artista plástica",
  cerrajero:     "Cerrajero",
  ...
  compostura:          "Compostura de calzado",
  "papeleria-creativa": "Papelería creativa",
  ...
  mascotas:      "Mascotas",
  ninos:         "Niños",
  "pagos-agencias": "Pagos y Agencias",
