    ...
    <div className="relative z-[110] min-h-screen pb-24" style={{ background: "#F0EBE0" }}>
      <div className="max-w-2xl mx-auto px-4 flex flex-col gap-y-4 pt-5">
        ...
        {Array.isArray(business.professionals) && business.professionals.length > 0 && (() => {
          ...
          return (
            <div className="bg-white rounded-3xl border border-stone-100 shadow-sm p-5">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] mb-3" style={{ color: "rgba(45,69,48,0.40)" }}>
                Profesionales
              </p>
              ...
              {business.appointment_system && (
                <p className="text-xs text-stone-500 mb-4">{business.appointment_system}</p>
              )}
              <div className="space-y-5">
                {Object.entries(groups).map(([group, members]) => (
                  <div key={group}>
                    <p className="text-[10px] font-black uppercase tracking-[0.15em] mb-3 pb-1.5 border-b border-stone-100"
                      style={{ color: "#2D4530" }}>
                      {group}
                    </p>
                    <div className="grid grid-cols-2 gap-3">
                      {(members as any[]).map((pro: any, i: number) => {
                        ...
                        return (
                          <div
                            key={i}
                            className="rounded-2xl border border-stone-100 p-3 flex flex-col items-center text-center gap-2"
                          ...
                          >
                            ...
                            <div className="w-full">
                              <p className="text-xs font-bold leading-snug line-clamp-2" style={{ color: "#2D4530" }}>
                                {pro.name}
                              </p>
                              {pro.specialty && (
                                <p className="text-[10px] mt-0.5 line-clamp-1" style={{ color: "rgba(45,69,48,0.55)" }}>
                                  {pro.specialty}
                                </p>
                              )}
                            </div>
                            ...
                            {/* Descripción */}
                            {pro.description && (
                              <p className="text-[10px] line-clamp-2 leading-relaxed w-full text-left"
                            ...
                            {/* Horario */}
                            {pro.schedule && (
                              <p className="text-[10px] w-full text-left" style={{ color: "rgba(45,69,48,0.45)" }}>
                                🕐 {pro.schedule}
                              </p>
                            )}
                            ...
                            {waUrl && (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="mt-auto w-full flex items-center justify-center gap-1.5 py-2 rounded-xl text-xs font-semibold text-white transition-opacity hover:opacity-90 active:scale-95"
                                style={{ background: "#25D366" }}
                              >
                                <WaIcon size={13} />
                                WhatsApp
                            ...
                            {!waUrl && pro.contact?.startsWith("http") && (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="mt-auto w-full flex items-center justify-center gap-1.5 py-2 rounded-xl text-xs font-semibold transition-colors hover:opacity-80"
                                style={{ background: "rgba(45,69,48,0.08)", color: "#2D4530" }}
                              >
                                📅 Sacar turno
                              </a>
        ...
        {photos.length > 0 && (
          <div className="flex flex-col gap-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* aspect-[4/3] en mobile para fotos más grandes, aspect-video en desktop */}
              <button
                onClick={() => setLightboxIdx(photoIdx)}
                className="flex-1 aspect-[4/3] sm:aspect-video rounded-2xl overflow-hidden relative bg-white cursor-zoom-in block"
