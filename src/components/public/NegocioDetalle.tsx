        ...
        {business.section === "gastronomy" && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <button
              ...
              disabled={!hasMenu}
              className="flex items-center justify-center gap-2 py-4 rounded-2xl font-bold text-sm shadow-md transition-all active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed"
              style={{ background: "#2D4530", color: "#E1DBC9" }}
            >
            ...
            <div className="space-y-0">
              {todayMenu.daily_menu_items.map((item: any) => (
                <div key={item.id} className="flex items-center justify-between py-3 border-b border-stone-100 last:border-0">
                  ...
                  <p className="font-bold shrink-0 text-sm" style={{ color: "#2D4530" }}>
              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-3 rounded-xl text-sm font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-white active:scale-95"
                    style={{ background: "#25D366" }}
                  >
                    {WA_SVG}
