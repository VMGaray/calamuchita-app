...
const businesses = [
  { id: "1", name: "La Casona del Valle", type: "Restaurante", location: "VGB", open: true, hasMenu: true, bg: "bg-primary-100" },
  { id: "2", name: "Café del Bosque", type: "Café", location: "Los Reartes", open: true, hasMenu: false, bg: "bg-accent-100" },
  { id: "3", name: "El Rincón Serrano", type: "Parrilla", location: "Santa Rosa", open: false, hasMenu: false, bg: "bg-stone-200" },
  { id: "4", name: "Viandas de María", type: "Viandas", location: "VGB", open: true, hasMenu: true, bg: "bg-purple-100" },
]
    ...
    <div className="mb-12">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {businesses.map(({ id, name, type, location, open, hasMenu, bg }, i) => (
            <AnimateIn key={id} direction="up" delay={i * 0.1}>
