...
const SYNONYMS: Record<string, string[]> = {
  ...
  cerco:          ["Alambrados"],
  tejido:         ["Alambrados"],
  animacion:      ["Animación Cumpleaños", "Animación de eventos"],
  cumpleanos:     ["Animación Cumpleaños"],
  cumpleaños:     ["Animación Cumpleaños"],
  animador:       ["Animación Cumpleaños", "Animación de eventos"],
  eventos:        ["Animación de eventos"],
  "animador de eventos": ["Animación de eventos"],
