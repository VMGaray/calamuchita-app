export const sectionCategories = {
  gastronomy: [
    ...
    { label: "Bar/Café", desc: "Tragos, café y más", href: "/negocios?categoria=cafe", bg: "bg-brand-earth/10", color: "text-brand-earth" },
    ...
    { label: "Pastelería", desc: "Tortas, postres y repostería", href: "/negocios?categoria=pasteleria", bg: "bg-brand-earth/10", color: "text-brand-earth" },
    { label: "Sushi", desc: "Rolls y cocina japonesa", href: "/negocios?categoria=sushi", bg: "bg-stone-50", color: "text-stone-600" },
    { label: "Comida para llevar", desc: "Pedidos para retirar o delivery", href: "/negocios?categoria=comida_para_llevar", bg: "bg-brand-slate/10", color: "text-brand-slate" },
    { label: "Pizzería", desc: "Pizzas al molde y a la piedra", href: "/negocios?categoria=pizzeria", bg: "bg-brand-earth/10", color: "text-brand-earth" },
    { label: "Hamburguesería", desc: "Burgers artesanales y clásicas", href: "/negocios?categoria=hamburgueseria", bg: "bg-brand-slate/10", color: "text-brand-slate" },
 ...
 services: [
    ...
    { label: "Ambientación de eventos", desc: "Decoración, sonido e iluminación para eventos y fiestas", href: "/directorio/services?cat=ambientacion-eventos", bg: "bg-brand-slate/10", color: "text-brand-slate" },
    ...
    { label: "Gestoría", desc: "Trámites y gestiones administrativas", href: "/directorio/services?cat=gestoria", bg: "bg-brand-charcoal/10", color: "text-brand-charcoal" },
  ...
  commerce: [
    ...
    { label: "Pagos y Agencias", desc: "Rapipago, Pago Fácil y agencias", href: "/directorio/commerce?cat=pagos-agencias", bg: "bg-brand-slate/10", color: "text-brand-slate" },
    { label: "Peluquería canina", desc: "Baño y peluquería para perros", href: "/directorio/commerce?cat=peluqueria-canina", bg: "bg-brand-pine/10", color: "text-brand-pine" },
    { label: "Petshop", desc: "Alimento y accesorios para mascotas", href: "/directorio/commerce?cat=petshop", bg: "bg-brand-earth/10", color: "text-brand-earth" },
    { label: "Regalería", desc: "Regalos, souvenirs y detalles", href: "/directorio/commerce?cat=regaleria", bg: "bg-brand-earth/10", color: "text-brand-earth" },
    ...
    { label: "Vivero", desc: "Plantas, plantines y jardinería", href: "/directorio/commerce?cat=vivero", bg: "bg-brand-pine/10", color: "text-brand-pine" },
