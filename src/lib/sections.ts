export const sectionCategories = {
  ...
  services: [
    ...
    { label: "Licenciado en higiene y seguridad", desc: "Profesionales matriculados en H&S", href: "/directorio/services?cat=licenciado-hys", bg: "bg-brand-pine/10", color: "text-brand-pine" },
