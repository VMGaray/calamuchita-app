import {
  Wrench, Zap, Flame, Car, Building, Paintbrush, Hammer, KeyRound, Leaf, Waves, Home, Bug, Sparkles, Droplets, Shield, Scissors, Fish,
...
export const MASTER_CATEGORIES = {
  gastronomy: {
    ...
    subcategories: [
      ...
      { label: "Sushi", icon: Fish, bg: "bg-sky-50", color: "text-sky-600" },
